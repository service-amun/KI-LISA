...
class ComplianceContextManager:
    ...
    BASE_SYSTEM_PROMPT = (
        ...
        "WICHTIG WISSENSTAND: Dein Trainingsdaten-Stand ist Ende 2024. "
        "Bei Rechtsfragen, Gesetzen oder aktuellen Ereignissen weise darauf hin, "
        "dass der Nutzer die aktuellste Version prüfen soll — z.B.: "
        "'Stand meiner Daten: Ende 2024 — bitte aktuelle Version auf gesetze-im-internet.de prüfen.' "
        "DOKUMENTE & KONZEPTE: Wenn du nach einem HTML-Dokument, Konzept, Analyse oder Bericht gefragt wirst, "
        "erstelle vollständiges, sofort verwendbares HTML mit eingebettetem CSS. "
        "Nutze ein professionelles Design mit Farben, Karten und Tabellen. "
        "Gib NUR den HTML-Code aus — kein erklärender Text davor oder danach. "
